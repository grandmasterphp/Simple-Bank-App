  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          final transactionData = transactionnn[index];
          return InkWell(
                      ...
                      children: [
                        DataTable(columns: const [
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(Text(transactionData['status'].toString()))
                          ]),
                          DataRow(cells: [
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(
                                Text(transactionData['description'].toString()))
                          ])
                        ]),
                        Padding(
            ...
            child: ListTile(
              ...
              tileColor: index.isOdd
                  ? const Color.fromARGB(255, 1, 35, 52)
